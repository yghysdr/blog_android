package io.yghysdr.common.common.util;
...
public class ThemeUtil {
    ...
    public static int getColorId(@ColorType int type) {
        return BaseApp.getContext().getResources().getColor(getResId(type));
    }
    ...
    public static void showAnimation(Activity activity) {
        ...
        if (decorView instanceof ViewGroup && cacheBitmap != null) {
            final View view = new View(BaseApp.getContext());
            view.setBackgroundDrawable(new BitmapDrawable(BaseApp.getRes(), cacheBitmap));
