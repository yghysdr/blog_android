...
public class IDCardValidate {
     ...
     *  验证身份证有效性
     */
    public static boolean validate_effective_ID(String idcardNumber){
        boolean isIdCard = false;
        String resultId = validate_effective(idcardNumber, true);

        return idcardNumber.equals(resultId)?true:false;
    }
