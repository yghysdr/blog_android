...
public final class AnimationUtils {
    ...
    public enum ScaleMode {
        UP_DOWN_SPREAD,//从上往下展开
        DOWN_UP_SPREAD,//从下往上展开
        DOWN_UP_SHRINK//从下往上收缩
    }

    public static ScaleAnimation getScaleAnimation(ScaleMode mode) {
        ScaleAnimation scaleAnimation;
        if (mode == ScaleMode.DOWN_UP_SHRINK) {
            scaleAnimation = new ScaleAnimation(1f, 1f, 0f, 1f, Animation.RELATIVE_TO_SELF, 1, Animation.RELATIVE_TO_SELF, 1);
        } else if (mode == ScaleMode.DOWN_UP_SPREAD) {
            scaleAnimation = new ScaleAnimation(1f, 1f, 1f, 0f);
        } else {
            scaleAnimation = new ScaleAnimation(1f, 1f, 0f, 1f);
        }
        scaleAnimation.setDuration(DEFAULT_ANIMATION_DURATION);
